        ...
        interfaz.getTFMensaje().addKeyListener(new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    new EnviarMsg().enviarMensaje(interfaz.getNombre(), interfaz.getTFMensaje().getText());
...
//                    System.out.println("Color: " + receivedColor);
                        ...
                        new EnviarMsg().enviarMensaje(interfaz.getNombre(), "envió un archivo " + nombreArchivo);
                    } else {
...
//                  
    ...
    public class EnviarMsg implements ActionListener {
        ...
        private void enviarMensaje(String nombre, String msg) {
            if (!interfaz.getTFMensaje().getText().isBlank()) {
                try {
                    out.writeUTF("TEXT");
...
//                interfaz.getTAMensaje().setCaretPosition(interfaz.getTAMensaje().getDocument().getLength());
        ...
        public void actionPerformed(ActionEvent e) {
            enviarMensaje(interfaz.getNombre(), interfaz.getTFMensaje().getText());
        }
...
//            fileChooser.setFileFilter(filter);
        ...
        private void enviarArchivo(File archivo) {
            new Thread(() -> {
                try (FileInputStream fis = new FileInputStream(archivo)) {
                    ...
                    System.out.println("la ruta es:" + System.getProperty("user.dir") + File.separator + archivo.getName());
    ...
    private void guardarArchivoEnDisco(String nombreArchivo, byte[] archivoBytes) {
        try {
            ...
            String rutaCarpetaRecibidos = System.getProperty("user.dir") + File.separator + "src" + File.separator + "recibidos";
