...
public class Server {
    ...
    private boolean checartipo = true;
...
//                                               asi es como el servidor sabe cuantos clientes hay
            ...
            try {
                ...
                while (clientSocket.isConnected()) {
                    ...
                    if ("TEXT".equals(tipo)) {
                        ...
                        enviarMensaje(n, msg, out);
                        System.out.println("Mensaje Cliente: " + n + ":" + msg);
                        guardarMensajeEnHistorial(n, msg);
    ...
    private synchronized void enviarMensaje(String n, String msg, DataOutputStream sender) {
...
//            }
    ...
    private void guardarMensajeEnHistorial(String nick, String mensaje) {
    ...
    private synchronized void recibirArchivo(String fileName, DataInputStream in) {
